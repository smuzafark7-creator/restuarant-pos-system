...
export const CashierCategorySidebar: React.FC<CashierCategorySidebarProps> = ({
  ...
  return (
    <aside
      ...
      className="w-48 sm:w-52 xl:w-56 bg-[#0f172a] text-slate-300 flex flex-col justify-between border-r border-slate-800 h-full flex-shrink-0 sticky top-0 overflow-hidden select-none font-sans z-10"
    >
      {/* Category Header */}
      ...
      {/* Footer Info */}
      <div className="p-3 border-t border-slate-800 bg-[#0f172a] text-[11px] text-slate-400 shrink-0 flex items-center justify-between">
