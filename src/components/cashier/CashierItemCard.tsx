...
export interface CashierItemCardProps {
  item: MenuItem;
  inCartQty: number;
...
export const CashierItemCard: React.FC<CashierItemCardProps> = ({
  item,
  inCartQty,
  onAdd,
  onIncrement,
  ...
  return (
    ...
    >
      {/* Top Row: Avatar badge + Veg/Non-veg tag & Popular */}
      <div>
      ...
      <div className="mt-3 pt-2 border-t border-slate-800 font-mono">
        {inCartQty > 0 ? (
          ...
          <button
            ...
            title="Add item to cashier bill"
          >
